...
public:
    ...
    /**
     * Public interface to handle received messages after a delay
     */
    void ProcessReceivedMessage(const PeerAddress & peerAddress, System::PacketBufferHandle && buffer, MessageTransportContext * msgContext = nullptr);
