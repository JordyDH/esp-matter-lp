    ...
    if (event->Type == DeviceEventType::kESPSystemEvent)
    {
        ...
        if (event->Platform.ESPSystemEvent.Base == IP_EVENT)
        {
            ...
            case IP_EVENT_GOT_IP6:
                ...
                ChipLogProgress(DeviceLayer, "IP_EVENT_GOT_IP6 - delay %d ms - START", IP_EVENT_GOT_IP6_DELAY);
                vTaskDelay(pdMS_TO_TICKS(IP_EVENT_GOT_IP6_DELAY));
                ChipLogProgress(DeviceLayer, "IP_EVENT_GOT_IP6 - delay %d ms - END", IP_EVENT_GOT_IP6_DELAY);   
